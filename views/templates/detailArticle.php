        ...
        if (empty($comments)) {
            ...
            foreach ($comments as $comment) {
                ...
                if (isset($_SESSION['user']) ) {
                    ...
                    echo '          <a href="index.php?action=deleteComment&id=' . $commentId . '" ' . Utils::askConfirmation("Êtes-vous sûr de vouloir supprimer ce commentaire ?") .'>Supprimer le commentaire</a>';
                    echo '      </div>';
                }
                echo '  </div>';
                echo '</li>';
